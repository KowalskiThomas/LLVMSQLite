...
#
CC = gcc
CFLAGS =  -I/usr/local/opt/llvm/include  -g -O2 -DSQLITE_OS_UNIX=1 -DSQLITE_OMIT_TRACE -DSQLITE_OMIT_DEPRECATED -DSQLITE_OMIT_VIRTUALTABLE
...
OPT_FEATURE_FLAGS = -DSQLITE_OMIT_TRACE -DSQLITE_OMIT_VIRTUALTABLE
...
LTLINK = $(LIBTOOL) --mode=link $(TCC) $(LTCOMPILE_EXTRAS) -L/usr/local/opt/llvm/lib $(LTLINK_EXTRAS)
...
# thomas.lo:	$(TOP)/src/thomas.cpp $(HDR)
# 	$(LTCOMPILE) $(TEMP_STORE) -c $(TOP)/src/thomas.cpp
