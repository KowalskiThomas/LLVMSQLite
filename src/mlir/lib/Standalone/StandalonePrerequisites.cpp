...
LLVMFuncOp f_sqlite3VdbeIdxKeyCompare;
...
public:
    ...
    DECLARE_FUNCTION(sqlite3VdbeIdxKeyCompare);
...
void Prerequisites::generateReferenceTosqlite3VdbeIdxKeyCompare(ModuleOp m, LLVMDialect *d) {
    auto funcTy = LLVMType::getFunctionTy(
        T::i32Ty, {
            T::sqlite3PtrTy,
            T::VdbeCursorPtrTy,
    ...
    GENERATE_SYMBOL(f_sqlite3VdbeIdxKeyCompare, sqlite3VdbeIdxKeyCompare, "sqlite3VdbeIdxKeyCompare");
}

void Prerequisites::generateReferenceTosqlite3BtreeInsert(ModuleOp m, LLVMDialect *d) {
    auto funcTy = LLVMType::getFunctionTy(
            T::i32Ty, {
                T::BtCursorPtrTy,
                T::BtreePayloadPtrTy,
    ...
    GENERATE_SYMBOL(f_sqlite3BtreeInsert, sqlite3BtreeInsert, "sqlite3BtreeInsert");
}

void Prerequisites::generateReferenceTosqlite3BtreeCursorIsValidNN(ModuleOp m, LLVMDialect *d) {
    auto funcTy = LLVMType::getFunctionTy(
            T::i32Ty, {
                T::BtCursorPtrTy
            }, false);

    GENERATE_SYMBOL(f_sqlite3BtreeCursorIsValidNN, sqlite3BtreeCursorIsValidNN, "sqlite3BtreeCursorIsValidNN");
}

void Prerequisites::generateReferenceTosqlite3BtreeLast(ModuleOp m, LLVMDialect *d) {
    auto funcTy = LLVMType::getFunctionTy(
            T::i32Ty, {
                T::BtCursorPtrTy,
                T::i32PtrTy
...
void Prerequisites::generateReferenceTosqlite3VdbeMemCast(ModuleOp m, LLVMDialect *d) {
    auto funcTy = LLVMType::getFunctionTy(
            T::i32Ty, {
                T::sqlite3_valuePtrTy,
                T::i8Ty,
    ...
    GENERATE_SYMBOL(f_sqlite3VdbeMemCast, sqlite3VdbeMemCast, "sqlite3VdbeMemCast");
}

void Prerequisites::generateReferenceTosqlite3BtreeGetMeta(ModuleOp m, LLVMDialect *d) {
    auto funcTy = LLVMType::getFunctionTy(
            T::voidTy, {
                T::BtreePtrTy,
                T::i32Ty,
...
void Prerequisites::generateReferenceTosqlite3VdbeFreeCursor(ModuleOp m, LLVMDialect *d) {
    auto funcTy = LLVMType::getFunctionTy(
            T::voidTy, {
                T::VdbePtrTy,
                T::VdbeCursorPtrTy
...
void Prerequisites::runPrerequisites(ModuleOp m, LLVMDialect *d) {
    ...
    CALL_SYMBOL_GENERATOR(sqlite3VdbeIdxKeyCompare);
