...
void load_type_definitions(mlir::LLVM::LLVMDialect* d) {
    ...
    T::anon7Ty = t::createStructTy(d, Optional<StringRef>("anon.7"));
    ...
    T::anon0Ty = t::createStructTy(d, Optional<StringRef>("anon.0"));
    ...
    T::anon8Ty = t::createStructTy(d, Optional<StringRef>("anon.8"));
    T::anon4Ty = t::createStructTy(d, Optional<StringRef>("anon.4"));
    ...
    T::anon1Ty = t::createStructTy(d, Optional<StringRef>("anon.1"));
    ...
    T::anon6Ty = t::createStructTy(d, Optional<StringRef>("anon.6"));
