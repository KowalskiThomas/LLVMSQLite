...
** is Win9x or WinNT.
*/
int winGetReadLock(winFile *pFile){
  int res;
...
*/
int winLockSharedMemory(winShmNode *pShmNode){
...
*/
char *winConvertToUtf8Filename(const void *zFilename){
  char *zConverted = 0;
  if( osIsNT() ){
