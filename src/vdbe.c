...
*/
LLVMSQLITE_NOTSTATICANYMORE VdbeCursor *allocateCursor(
...
** return false.
*/
LLVMSQLITE_NOTSTATICANYMORE int alsoAnInt(Mem *pRec, double rValue, i64 *piValue){
...
*/
LLVMSQLITE_NOTSTATICANYMORE void applyNumericAffinity(Mem *pRec, int bTryForInt){
  double rValue;
  u8 enc = pRec->enc;
  int rc;
...
*/
LLVMSQLITE_NOTSTATICANYMORE void applyAffinity(
...
** accordingly.
*/
LLVMSQLITE_NOTSTATICANYMORE u16 SQLITE_NOINLINE computeNumericType(Mem *pMem){
  int rc;
  sqlite3_int64 ix;
...
*/
LLVMSQLITE_NOTSTATICANYMORE u16 numericType(Mem *pMem){
...
*/
LLVMSQLITE_NOTSTATICANYMORE SQLITE_NOINLINE Mem *out2PrereleaseWithClear(Mem *pOut){
  sqlite3VdbeMemSetNull(pOut);
  pOut->flags = MEM_Int;
  return pOut;
}
LLVMSQLITE_NOTSTATICANYMORE Mem *out2Prerelease(Vdbe *p, VdbeOp *pOp){
  Mem *pOut;
  assert( pOp->p2>0 );
